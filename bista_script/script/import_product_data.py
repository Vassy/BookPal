...
url = 'https://nikita-bistait-bookpal-bista-staging-5356920.dev.odoo.com'  # ESP-staging url
...
try:
    for row_no in range(1, 10):  #
        ...
        print ("\n prod_tmpl_id>>>>>.", prod_id, row_values[0])
        ...
        #         if vendor_price_list and vendor_price_list[0]:
        #             print ("\n continue ????")
        #             continue
        #         # sock.execute(
        #         #     dbname, uid, password,
