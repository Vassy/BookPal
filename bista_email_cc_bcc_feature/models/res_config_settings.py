...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        cc_recipient_ids = ICP.get_param("mail_compose_message.cc_recipient_ids", False)
        bcc_recipient_ids = ICP.get_param(
            "mail_compose_message.bcc_recipient_ids", False
        )
        res.update(enable_cc=enable_cc, enable_bcc=enable_bcc)
        if cc_recipient_ids:
            res.update(
