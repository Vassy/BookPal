...
class ResPartner(models.Model):
    ...
    non_conus_shipping = fields.Text(string="Non-CONUS Shipping")
    avg_processing_time = fields.Char(string="Days to ship")
    rush_processing_time = fields.Text(string="Rush days to ship")
    ...
    intl_shipping_notes = fields.Text(string="Int'l Shipping Notes")
    tracking_souurce = fields.Text(string="Tracking Source")
    ...
    pricing_profile = fields.Text(string="Pricing Profile")
    pricing_profile_notes = fields.Text(string="Pricing Profile Notes")
    price_match_discounts = fields.Text(string="Price Match Discounts")
    returnable_terms = fields.Text(string="Returnable Terms")
    # supplier_contact = fields.Char(string="Supplier Contact")
    supplier_discount = fields.Text(string="Supplier Discount (%)")
