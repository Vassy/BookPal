...
class ReturnPicking(models.TransientModel):
    ...
    # Commented code for solved traceback when retuning IN transfer
    ...
    #         if (
    #             return_picking.location_dest_id == vendor_location_id
    #             and return_picking.location_id == input_location_id
    #         ):
    #             return_picking.move_lines.move_orig_ids.mapped(
    #                 "purchase_line_id"
    #             ).status_id = self.env.ref("bista_purchase.status_line_return").id
